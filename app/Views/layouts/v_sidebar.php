            ...
            <ul class="navbar-nav pt-lg-3">
                ...
                <?php if ($role == 'admin') :  ?>
                    <li class="nav-item <?= $active == 'sekolah' ? 'active' : '' ?>">
                        <a class="nav-link" href="<?= base_url($role . '/sekolah') ?>">
                ...
                <li class="nav-item <?= $active == 'siswa'  ? 'active' : '' ?>">
                    <a class="nav-link" href="<?= base_url($role . '/siswa') ?>">
                ...
                <?php if ($role !== 'admin') :  ?>
                    <li class="nav-item <?= $active == 'bulk-siswa'  ? 'active' : '' ?>">
                        <a class="nav-link" href="<?= base_url($role . '/bulk-siswa') ?>">
                            <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/logout -->
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="icon"
                ...
                <li class="nav-item <?= $active == 'profil' ? 'active' : '' ?>">
                    <a class="nav-link" href="<?= base_url($role . '/profil') ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url($role . '/logout') ?>">
                        <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/logout -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
